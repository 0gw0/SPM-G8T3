...
import {GET} from "@/app/api/schedule/apply/route";
import { createClient } from '@/utils/supabase/server';
import { NextResponse, NextRequest } from 'next/server';
import { handler as viewOwnHandler } from '@/app/api/schedule/view-own/route';

import {doArrangementsConflict} from '@/app/api/schedule/apply/route';
...
jest.mock('@/app/api/schedule/view-own/route', () => ({
    handler: jest.fn()
}));
...
describe('POST handler for WFH arrangements', () => {
    ...
    it('successfully creates an adhoc full day arrangement and returns 200 status', async () => {
        ...
        jest.mock('@/app/api/schedule/apply/route', () => ({
